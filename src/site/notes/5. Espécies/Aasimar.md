...
***Portador da Luz***. Você conhece o truque [[2. Magias/Truques/Luz\|Luz]]. Carisma é seu atributo de conjuração para isso.

***Revelação Celestial***. No nível 3 de personagem, você pode se transformar como uma [[8. Geral/Combate/Ação Bônus\|Ação Bônus]] usando uma das opções abaixo (escolha a opção cada vez que você se transformar). A transformação se mantém por 1 min ou até você a encerrar (nenhuma ação é necessária). Uma vez que você se transforma, não pode fazê-lo novamente até completar um [[8. Geral/Descanso/Descanso Longo\|Descanso Longo]]. Uma vez em cada um dos seus turnos, até que a transformação termine, você pode infligir dano adicional a um alvo ao causar dano a ele com um ataque ou uma magia. O dano adicional é igual ao seu Bônus de Proficiência, e o tipo de dano adicional é Necrótico para *Manto Necrótico* ou Radiante para *Asas Celestiais* e *Transfiguração Radiante*.

Aqui estão as opções de transformação:
