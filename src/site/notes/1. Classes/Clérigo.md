---
{"dg-publish":true,"permalink":"/1-classes/clerigo/","title":"Clérigo","created":"2026-02-10T23:28:29.238-03:00","updated":"2026-02-11T00:34:18.586-03:00"}
---
...
| Proficiência em Perícias     | Escolha 2: História, Intuição, Medicina, Persuasão ou Religião                                                           |
| Proficiência com Armas       | Armas Simples                                                                                                            |
| Treinamento com Armadura     | Armadura Leve e Média e Escudos                                                                                          |
| Equipamento Inicial          | Escolha A ou B: (A) Cota de Malha Parcial, Escudo, Maça, [[6. Itens/Equipamentos de Aventura/Símbolo Sagrado\|Símbolo Sagrado]], [[6. Itens/Equipamentos de Aventura/Kit de Sacerdote\|Kit de Sacerdote]] e 7 po; ou (B) 110 po |

Clérigo canalizam o poder dos reinos dos deuses para realizar milagres. Abençoados por uma divindade, panteão ou outra entidade imortal, os Clérigos acessam a magia divina dos Planos Externos — onde habitam os deuses — e a utilizam para fortalecer os necessitados e enfrentar inimigos.
...
- Adquira todos os traços na tabela Traços Básicos de Clérigo.
- Adquira as características de nível 1 de Clérigo, apresentadas na tabela Características de Clérigo.
...
| Nível | Bônus de Proficiência | Características                                                                            | Canalizar Divindade | Truques | Magias Preparadas | 1°  | 2°  | 3°  | 4°  | 5°  | 6°  | 7°  | 8°  | 9°  |
| :---: | :-------------------: | ------------------------------------------------------------------------------------------ | :-----------------: | :-----: | :---------------: | :-: | --- | --- | --- | --- | --- | --- | --- | --- |
|   1   |          + 2          | [[1. Classes/Clérigo#Nível 1 Conjuração\|Conjuração]], [[1. Classes/Clérigo#Nível 1 Ordem Divina\|Ordem Divina]] |          -          |    3    |         4         |  2  | -   | -   | -   | -   | -   | -   | -   | -   |
|   2   |          + 2          | [[1. Classes/Clérigo#Nível 2 Canalizar Divindade\|Canalizar Divindade]]                               |          2          |    3    |         5         |  3  | -   | -   | -   | -   | -   | -   | -   | -   |
|   3   |          + 2          | [[1. Classes/Clérigo#Nível 3 Subclasse de Clérigo\|Subclasse de Clérigo]]                             |          2          |    3    |         6         |  4  | 2   | -   | -   | -   | -   | -   | -   | -   |
|   4   |          + 2          | [[1. Classes/Clérigo#Nível 4 Aumento no Valor de Atributo\|Aumento no Valor de Atributo]]             |          2          |    4    |         7         |  4  | 3   | -   | -   | -   | -   | -   | -   | -   |
|   5   |          + 3          | [[1. Classes/Clérigo#Nível 5 Fulminar Mortos-Vivos\|Fulminar Mortos-Vivos]]                           |          2          |    4    |         9         |  4  | 3   | 2   | -   | -   | -   | -   | -   | -   |
|   6   |          + 3          | Característica de [[1. Classes/Clérigo#Nível 3 Subclasse de Clérigo\|Subclasse]]                      |          3          |    4    |        10         |  4  | 3   | 3   | -   | -   | -   | -   | -   | -   |
|   7   |          + 3          | [[1. Classes/Clérigo#Nível 7 Golpes Abençoados\|Golpes Abençoados]]                                   |          3          |    4    |        11         |  4  | 3   | 3   | 1   | -   | -   | -   | -   | -   |
|   8   |          + 3          | [[1. Classes/Clérigo#Nível 4 Aumento no Valor de Atributo\|Aumento no Valor de Atributo]]             |          3          |    4    |        12         |  4  | 3   | 3   | 2   | -   | -   | -   | -   | -   |
|   9   |          + 4          | -                                                                                          |          3          |    4    |        14         |  4  | 3   | 3   | 3   | 1   | -   | -   | -   | -   |
|  10   |          + 4          | [[1. Classes/Clérigo#Nível 10 Intervenção Divina\|Intervenção Divina]]                                |          3          |    5    |        15         |  4  | 3   | 3   | 3   | 2   | -   | -   | -   | -   |
|  11   |          + 4          | -                                                                                          |          3          |    5    |        16         |  4  | 3   | 3   | 3   | 3   | 1   | -   | -   | -   |
|  12   |          + 4          | [[1. Classes/Clérigo#Nível 4 Aumento no Valor de Atributo\|Aumento no Valor de Atributo]]             |          3          |    5    |        16         |  4  | 3   | 3   | 3   | 3   | 1   | -   | -   | -   |
|  13   |          + 5          | -                                                                                          |          3          |    5    |        17         |  4  | 3   | 3   | 3   | 3   | 1   | 1   | -   | -   |
|  14   |          + 5          | [[1. Classes/Clérigo#Nível 14 Golpes Abençoados Aprimorados\|Golpes Abençoados Aprimorados]]          |          3          |    5    |        17         |  4  | 3   | 3   | 3   | 3   | 1   | 1   | -   | -   |
|  15   |          + 5          | -                                                                                          |          3          |    5    |        18         |  4  | 3   | 3   | 3   | 3   | 1   | 1   | 1   | -   |
|  16   |          + 5          | [[1. Classes/Clérigo#Nível 4 Aumento no Valor de Atributo\|Aumento no Valor de Atributo]]             |          3          |    5    |        18         |  4  | 3   | 3   | 3   | 3   | 1   | 1   | 1   | -   |
|  17   |          + 6          | Característica de [[1. Classes/Clérigo#Nível 3 Subclasse de Clérigo\|Subclasse]]                      |          3          |    5    |        19         |  4  | 3   | 3   | 3   | 3   | 1   | 1   | 1   | 1   |
|  18   |          + 6          | -                                                                                          |          4          |    5    |        20         |  4  | 3   | 3   | 3   | 3   | 1   | 1   | 1   | 1   |
|  19   |          + 6          | [[1. Classes/Clérigo#Nível 19 Dádiva Épica\|Dádiva Épica]]                                            |          4          |    5    |        21         |  4  | 3   | 3   | 3   | 3   | 2   | 1   | 1   | 1   |
|  20   |          + 6          | [[1. Classes/Clérigo#Nível 20 Intervenção Divina Maior\|Intervenção Divina Maior]]                    |          4          |    5    |        22         |  4  | 3   | 3   | 3   | 3   | 2   | 2   | 1   | 1   |
...
***Mudando Suas Magias Preparadas***. Sempre que completar um [[8. Geral/Descanso/Descanso Longo\|Descanso Longo]], você pode definir sua lista de magias preparadas, substituindo qualquer uma das magias por outras magias de Clérigo para as quais você tem espaços de magia.
...
Você se infunde de poder divino em combate. Você adquire uma das seguintes opções à sua escolha.
...
***Conjuração Poderosa***. Quando conjurar um truque de Clérigo e causar dano a uma criatura com ele, você pode conferir vitalidade a si ou a outra criatura a até 18 m (60 ft.) de você, concedendo um número de Pontos de Vida Temporários igual ao dobro do seu modificador de Sabedoria.

***Golpe Divino***. O dano adicional de seu Golpe Divino aumenta para 2d8.

## Nível 19: Dádiva Épica
Você adquire o talento [[3. Talentos/Dádivas Épicas/Talentos de Dádiva Épica\|Dádiva Épica]] ou outro [[3. Talentos/Talento\|Talento]] à sua escolha para o qual se qualifica. [[3. Talentos/Dádivas Épicas/Dádiva do Destino\|Dádiva do Destino]] é recomendada.

## Nível 20: Intervenção Divina Maior
Você pode convocar uma intervenção divina ainda mais poderosa. Quando usar sua característica [[1. Classes/Clérigo#Nível 10 Intervenção Divina\|Intervenção Divina]], você pode escolher [[2. Magias/9° Círculo/Desejo\|Desejo]] como opção de magia. Se fizer isso, não pode usar Intervenção Divina novamente até completar 2d4 [[8. Geral/Descanso/Descanso Longo\|Descansos Longos]].