---
{"dg-publish":true,"permalink":"/1-classes/subclasses/ladino/ladrao/","title":"Ladrão","created":"2026-02-10T23:28:29.568-03:00","updated":"2026-02-11T00:37:44.558-03:00"}
---
...
### Nível 3: Mão Leve
Como uma [[8. Geral/Combate/Ação Bônus\|Ação Bônus]], você pode executar uma das seguintes coisas.

***Prestidigitação***. Realize um teste de Destreza (Prestidigitação) para abrir uma fechadura ou desarmar uma armadilha com [[6. Itens/Ferramentas/Ferramentas de Ladrão\|Ferramentas de Ladrão]], ou para roubar um bolso.

***Usar Objeto***. Execute a ação [[8. Geral/Ações em Combate/Usar Objeto\|Usar Objeto]] ou a ação [[8. Geral/Ações em Combate/Usar Magia\|Usar Magia]] para utilizar um item mágico que exija essa ação.
...
***Sintonização***. Você pode [[6. Itens/Aspetos de Itens Mágicos/Sintonização\|Sintonizar]] até quatro itens mágicos ao mesmo tempo.
