...
Ao atingir uma criatura com um ataque concedido por sua [[1. Classes/Monge#Nível 2 Foco do Monge\|Torrente de Golpes]], você pode impor um dos seguintes efeitos ao alvo.
...
Você adquire a capacidade de se curar. Como uma [[8. Geral/Combate/Ação Bônus\|Ação Bônus]], você pode jogar seu [[1. Classes/Monge#Nível 1 Artes Marciais\|dado de Artes Marciais]]. Você recupera um número de Pontos de Vida igual ao resultado mais seu modificador de Sabedoria (mínimo de 1 Ponto de Vida recuperado).
