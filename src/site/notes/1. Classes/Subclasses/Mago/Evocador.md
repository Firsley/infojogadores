...
Seus estudos se concentram em magia que cria poderosos efeitos elementais, como frio intenso, chamas abrasadoras, trovões ensurdecedores, relâmpagos crepitantes e ácido corrosivo. Alguns Evocadores atuam em forças militares, servindo como artilharia para atacar exércitos à distância. Outros utilizam seus poderes para proteção, enquanto alguns buscam benefício pessoal.
...
Escolha duas magias de [[1. Classes/Mago\|Mago]] da escola de [[8. Geral/Escolas de Magia/Evocação\|Evocação]], cada uma deve ser de 2° círculo ou inferior, e adicione-as gratuitamente ao seu livro de magias.
