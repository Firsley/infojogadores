...
| Proficiência em Salvaguardas | Constituição (CON) e Carisma (CAR)                                                                                       |
| Proficiência em Perícias     | Escolha 2: Arcanismo, Enganação, Intimidação, Intuição, Persuasão ou Religião.                                           |
| Proficiências com Armas      | Armas Simples                                                                                                            |
| Treinamento com Armadura     | Nenhuma                                                                                                                  |
| Equipamento Inicial          | Escolha A ou B: (A) Lança, 2 Adagas, [[6. Itens/Equipamentos de Aventura/Foco Arcano\|Foco Arcano]] (cristal), [[6. Itens/Equipamentos de Aventura/Kit de Explorador de Masmorras\|Kit de Explorador de Masmorras]] e 28 po; ou (B) 50 po |
...
Feiticeiros são raros. Algumas linhagens familiares geram apenas um Feiticeiro por geração, enquanto, geralmente, esse dom aparece de forma inesperada. Aqueles que possuem esse poder logo percebem que não conseguem ficar ociosos. A magia de um Feiticeiro anseia por ser utilizada.

# Tornando-se um Feiticeiro...

## Como um Personagem de Nível 1
- Adquira todos os traços na tabela Traços Básicos de Feiticeiro.
...
| :---: | :-------------------: | -------------------------------------------------------------------------------------------------------- | :------------------: | :-----: | ----------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|   1   |          + 2          | [[1. Classes/Feiticeiro#Nível 1 Conjuração\|Conjuração]], [[1. Classes/Feiticeiro#Nível 1 Feitiçaria Inata\|Feitiçaria Inata]] |          -           |    4    | 2                 | 2   | -   | -   | -   | -   | -   | -   | -   | -   |
|   2   |          + 2          | [[1. Classes/Feiticeiro#Nível 2 Fonte de Magia\|Fonte de Magia]], [[1. Classes/Feiticeiro#Nível 2 Metamagia\|Metamagia]]       |          2           |    4    | 4                 | 3   | -   | -   | -   | -   | -   | -   | -   | -   |
|   3   |          + 2          | [[1. Classes/Feiticeiro#Nível 3 Subclasse de Feiticeiro\|Subclasse de Feiticeiro]]                                  |          3           |    4    | 6                 | 4   | 2   | -   | -   | -   | -   | -   | -   | -   |
|   4   |          + 2          | [[1. Classes/Feiticeiro#Nível 4 Aumento no Valor de Atributo\|Aumento no Valor de Atributo]]                        |          4           |    5    | 7                 | 4   | 3   | -   | -   | -   | -   | -   | -   | -   |
|   5   |          + 3          | [[1. Classes/Feiticeiro#Nível 5 Restauração Feiticeira\|Restauração Feiticeira]]                                    |          5           |    5    | 9                 | 4   | 3   | 2   | -   | -   | -   | -   | -   | -   |
|   6   |          + 3          | Característica de [[1. Classes/Feiticeiro#Nível 3 Subclasse de Feiticeiro\|Subclasse]]                              |          6           |    5    | 10                | 4   | 3   | 3   | -   | -   | -   | -   | -   | -   |
|   7   |          + 3          | [[1. Classes/Feiticeiro#Nível 7 Feitiçaria Encarnada\|Feitiçaria Encarnada]]                                        |          7           |    5    | 11                | 4   | 3   | 3   | 1   | -   | -   | -   | -   | -   |
|   8   |          + 3          | [[1. Classes/Feiticeiro#Nível 4 Aumento no Valor de Atributo\|Aumento no Valor de Atributo]]                        |          8           |    5    | 12                | 4   | 3   | 3   | 2   | -   | -   | -   | -   | -   |
|   9   |          + 4          | -                                                                                                        |          9           |    5    | 14                | 4   | 3   | 3   | 3   | 1   | -   | -   | -   | -   |
|  10   |          + 4          | [[1. Classes/Feiticeiro#Nível 2 Metamagia\|Metamagia]]                                                              |          10          |    6    | 15                | 4   | 3   | 3   | 3   | 2   | -   | -   | -   | -   |
|  11   |          + 4          | -                                                                                                        |          11          |    6    | 16                | 4   | 3   | 3   | 3   | 2   | 1   | -   | -   | -   |
|  12   |          + 4          | [[1. Classes/Feiticeiro#Nível 4 Aumento no Valor de Atributo\|Aumento no Valor de Atributo]]                        |          12          |    6    | 16                | 4   | 3   | 3   | 3   | 2   | 1   | -   | -   | -   |
|  13   |          + 5          | -                                                                                                        |          13          |    6    | 17                | 4   | 3   | 3   | 3   | 2   | 1   | 1   | -   | -   |
|  14   |          + 5          | Característica de [[1. Classes/Feiticeiro#Nível 3 Subclasse de Feiticeiro\|Subclasse]]                              |          14          |    6    | 17                | 4   | 3   | 3   | 3   | 2   | 1   | 1   | -   | -   |
|  15   |          + 5          | -                                                                                                        |          15          |    6    | 18                | 4   | 3   | 3   | 3   | 2   | 1   | 1   | 1   | -   |
|  16   |          + 5          | [[1. Classes/Feiticeiro#Nível 4 Aumento no Valor de Atributo\|Aumento no Valor de Atributo]]                        |          16          |    6    | 18                | 4   | 3   | 3   | 3   | 2   | 1   | 1   | 1   | -   |
|  17   |          + 6          | [[1. Classes/Feiticeiro#Nível 2 Metamagia\|Metamagia]]                                                              |          17          |    6    | 19                | 4   | 3   | 3   | 3   | 2   | 1   | 1   | 1   | 1   |
|  18   |          + 6          | Característica de [[1. Classes/Feiticeiro#Nível 3 Subclasse de Feiticeiro\|Subclasse]]                              |          18          |    6    | 20                | 4   | 3   | 3   | 3   | 3   | 1   | 1   | 1   | 1   |
|  19   |          + 6          | [[1. Classes/Feiticeiro#Nível 19 Dádiva Épica\|Dádiva Épica]]                                                       |          19          |    6    | 21                | 4   | 3   | 3   | 3   | 3   | 2   | 1   | 1   | 1   |
|  20   |          + 6          | [[1. Classes/Feiticeiro#Nível 20 Apoteose Arcana\|Apoteose Arcana]]                                                 |          20          |    6    | 22                | 4   | 3   | 3   | 3   | 3   | 2   | 2   | 1   | 1   |

# Características de Classe de Feiticeiro
Como Feiticeiro, você recebe as seguintes características de classe ao alcançar os níveis especificados de Feiticeiro. Essas características são apresentadas na tabela Características de Feiticeiro.

## Nível 1: Conjuração
Através da sua magia inata, você pode conjurar magias. As informações abaixo detalham como você usa essas regras com magias de Feiticeiro, que aparecem na [[2. Magias/Listas de Magias/Lista de Magias de Feiticeiro\|Lista de Magias de Feiticeiro]] mais adiante na descrição da classe.

***Truques***. Você conhece quatro truques de Feiticeiro à sua escolha. [[2. Magias/Truques/Explosão Elemental\|Explosão Elemental]], [[2. Magias/Truques/Luz\|Luz]], [[2. Magias/Truques/Prestidigitação Arcana\|Prestidigitação Arcana]] e [[2. Magias/Truques/Toque Chocante\|Toque Chocante]] são recomendados. Ao alcançar um nível de Feiticeiro, você pode substituir um dos seus truques dessa característica por outro truque de Feiticeiro à sua escolha.
...
***Espaços de Magia***. A tabela Características de Feiticeiro mostra quantos espaços de magia você tem para conjurar suas magias de 1° círculo ou superior. Você restaura todos os espaços gastos ao completar um [[8. Geral/Descanso/Descanso Longo\|Descanso Longo]].
...
| Círculo de Espaço de Magia | Custo de Ponto de Feitiçaria | Nível Mínimo de Feiticeiro |
| :------------------------: | :--------------------------: | :------------------------: |
|             1              |              2               |             2              |
|             2              |              3               |             3              |
|             3              |              5               |             5              |
...
|             5              |              7               |             9              |
## Nível 2: Metamagia
Sua magia flui de dentro para fora, permitindo que você ajuste suas magias conforme necessário. Você adquire duas [[1. Classes/Listas de Características de Classes/Opções de Metamagia/Opções de Metamagia\|Opções de Metamagia]] à sua escolha. Essas opções podem ser usadas para modificar temporariamente as magias que conjura, consumindo a quantidade correspondente de Pontos de Feitiçaria.
...
Enquanto sua característica [[1. Classes/Feiticeiro#Nível 1 Feitiçaria Inata\|Feitiçaria Inata]] estiver ativa, você pode usar uma opção de [[1. Classes/Feiticeiro#Nível 2 Metamagia\|Metamagia]] em cada um de seus turnos sem gastar Pontos de Feitiçaria com ela.
