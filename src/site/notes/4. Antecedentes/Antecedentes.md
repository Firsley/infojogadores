...
***Equipamento***. Cada antecedente oferece uma escolha entre um pacote de equipamentos ou 50 po.

### Descrições dos Antecedentes
Dezesseis antecedentes são apresentados nesta seção em ordem alfabética:

| Antecedente                                   | Atributos                                     | Perícias                                              |
| --------------------------------------------- | --------------------------------------------- | ----------------------------------------------------- |
| [[4. Antecedentes/Acólito\|Acólito]]       | <ul><li>INT</li><li>SAB</li><li>CAR</li></ul> | <ul><li>Intuição</li><li>Religião</li></ul>           |
