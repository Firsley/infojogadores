...
Esta magia encerra se uma das ações que você usar durante este período, ou quaisquer efeitos que você criar durante ela, afetar uma criatura que não seja você ou um objeto que esteja sendo usado ou carregado por alguém que não seja você. Além disso, a magia encerra se você se mover para um lugar a mais de 300 m do local onde a conjurou.

Fonte: Livro do Jogador (PHB), p. 315