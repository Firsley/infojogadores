...
Se uma magia não consumir seus materiais nem especificar um custo, o conjurador pode usar uma [[6. Itens/Equipamentos de Aventura/Bolsa de Componentes\|Bolsa de Componentes]] em vez de fornecer os materiais necessários, ou substituí-los por um Foco de Conjuração, se alguma característica permitir. Para utilizar a [[6. Itens/Equipamentos de Aventura/Bolsa de Componentes\|Bolsa de Componentes]], é necessário ter uma mão livre; já o Foco de Conjuração deve ser segurado, a menos que sua descrição indique o contrário.